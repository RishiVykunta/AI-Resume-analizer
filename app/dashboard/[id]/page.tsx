    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex gap-4">
          <button className="px-6 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-sm font-medium">
            Download PDF
          </button>
          <button className="px-6 py-2 rounded-xl bg-primary text-white hover:bg-red-500 transition-all text-sm font-medium shadow-lg shadow-primary/20">
            Share Results
          </button>
        </div>
      </div>
